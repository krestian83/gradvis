...
import '../application/multiplication_quiz_trinn3_session_controller.dart';

class MultiplicationQuizTrinn3Game extends StatefulWidget
    implements GameWidget {
  @override
  final ValueChanged<GameResult> onComplete;

  final Duration feedbackDelay;
  final MultiplicationQuizTrinn3SessionController? sessionController;

  const MultiplicationQuizTrinn3Game({
    super.key,
  ...
  @override
  State<MultiplicationQuizTrinn3Game> createState() =>
      _MultiplicationQuizTrinn3GameState();
}

class _MultiplicationQuizTrinn3GameState
    extends State<MultiplicationQuizTrinn3Game> {
  late final MultiplicationQuizTrinn3SessionController _session;
  ...
  void initState() {
    super.initState();
    _session =
        widget.sessionController ?? MultiplicationQuizTrinn3SessionController();
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Multiplikasjon - Trinn 3',
            style: theme.textTheme.headlineSmall,
          ),
          const SizedBox(height: 6),
          Text(
            'Velg riktig svar. Bruk hjelp-knappen oppe til hoyre ved behov.',
          ...
          Expanded(
            child: GridView.count(
              ...
              children: options.map((option) {
                ...
                return FilledButton(
                  key: ValueKey('multiplication-quiz-trinn3-option-$option'),
