...
class SubtractionTargetTrekSessionController {
  final List<SubtractionTargetTrekQuestion> _questions;
  int _index = 0;
  ...
  SubtractionTargetTrekSessionController({
    SubtractionTargetTrekEngine? engine,
    int roundCount = 8,
  }) : _questions = (engine ?? SubtractionTargetTrekEngine()).createQuestions(
         count: roundCount < 1 ? 1 : roundCount,
       );

  SubtractionTargetTrekQuestion get currentQuestion => _questions[_index];
