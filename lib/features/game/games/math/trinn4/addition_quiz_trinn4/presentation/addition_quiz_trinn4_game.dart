...
import '../application/addition_quiz_trinn4_session_controller.dart';

class AdditionQuizTrinn4Game extends StatefulWidget implements GameWidget {
  @override
  final ValueChanged<GameResult> onComplete;

  final Duration feedbackDelay;
  final AdditionQuizTrinn4SessionController? sessionController;

  const AdditionQuizTrinn4Game({
    super.key,
  ...
  @override
  State<AdditionQuizTrinn4Game> createState() => _AdditionQuizTrinn4GameState();
}

class _AdditionQuizTrinn4GameState extends State<AdditionQuizTrinn4Game> {
  late final AdditionQuizTrinn4SessionController _session;
  ...
  void initState() {
    super.initState();
    _session =
        widget.sessionController ?? AdditionQuizTrinn4SessionController();
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Addisjon - Trinn 4', style: theme.textTheme.headlineSmall),
          const SizedBox(height: 6),
          Text(
            'Regn med store tall. Bruk hjelp-knappen oppe til hoyre ved behov.',
          ...
          Expanded(
            child: GridView.count(
              ...
              children: options.map((option) {
                ...
                return FilledButton(
                  key: ValueKey('addition-quiz-trinn4-option-$option'),
