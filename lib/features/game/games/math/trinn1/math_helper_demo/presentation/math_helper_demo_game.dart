...
import '../application/math_helper_demo_session_controller.dart';
import '../../../../../math_help/application/math_help_controller.dart';
import '../../../../../math_help/application/math_help_scope.dart';

class MathHelperDemoGame extends StatefulWidget implements GameWidget {
  @override
  final ValueChanged<GameResult> onComplete;

  final Duration feedbackDelay;
  final MathHelperDemoSessionController? sessionController;

  const MathHelperDemoGame({
    super.key,
  ...
  @override
  State<MathHelperDemoGame> createState() => _MathHelperDemoGameState();
}

class _MathHelperDemoGameState extends State<MathHelperDemoGame> {
  late final MathHelperDemoSessionController _session;
  ...
  void initState() {
    super.initState();
    _session = widget.sessionController ?? MathHelperDemoSessionController();
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Math helper demo', style: theme.textTheme.headlineSmall),
          const SizedBox(height: 6),
          Text(
            'Bruk hjelp-knappen oppe til hoyre for visualisering.',
  ...
  Future<void> _onAnswerPressed(int answer) async {
