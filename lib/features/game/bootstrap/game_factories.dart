...
import '../games/math/trinn4/math_dash/presentation/math_dash_game.dart';
...
const mathDashFactoryKey = 'math_dash';
...
final Map<String, GameFactory> builtInGameFactories = {
  ...
  mathDashFactoryKey: ({required onComplete}) =>
      MathDashGame(onComplete: onComplete),
