...
import '../games/math/trinn4/number_storm_sprint/presentation/number_storm_sprint_game.dart';
...
const numberStormSprintFactoryKey = 'number_storm_sprint';
...
final Map<String, GameFactory> builtInGameFactories = {
  ...
  numberStormSprintFactoryKey: ({required onComplete}) =>
      NumberStormSprintGame(onComplete: onComplete),
