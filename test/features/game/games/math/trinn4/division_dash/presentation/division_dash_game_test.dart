...
import 'package:gradvis_v2/features/game/games/math/trinn4/division_dash/presentation/division_dash_game.dart';
...
Widget _buildGame({
  ...
  return MaterialApp(
    home: MathHelpScope(
      ...
      child: Scaffold(body: DivisionDashGame(onComplete: onComplete)),
    ),
  );
}

void main() {
  testWidgets('publishes division help context with operands', (tester) async {
    ...
    expect(context!.operation, 'division');
  ...
  testWidgets('completes and clears math help context', (tester) async {
    ...
    var safetyCounter = 0;
    while (result == null && safetyCounter < 15) {
      final context = helpController.context;
      expect(context, isNotNull);
