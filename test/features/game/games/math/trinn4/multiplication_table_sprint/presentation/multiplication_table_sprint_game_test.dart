...
import 'package:gradvis_v2/features/game/games/math/trinn4/multiplication_table_sprint/presentation/multiplication_table_sprint_game.dart';
...
Widget _buildGame({
  ...
  return MaterialApp(
    home: MathHelpScope(
      ...
      child: Scaffold(
        body: MultiplicationTableSprintGame(onComplete: onComplete),
      ),
    ),
  );
}
...
void main() {
  testWidgets('publishes multiplication help context with operands', (
    tester,
  ) async {
    ...
    expect(context!.operation, 'multiplication');
