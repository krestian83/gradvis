...
import 'package:gradvis_v2/features/game/games/math/trinn4/addition_bridge_builder/presentation/addition_bridge_builder_game.dart';
...
Widget _buildGame({
  ...
  return MaterialApp(
    home: MathHelpScope(
      ...
      child: Scaffold(body: AdditionBridgeBuilderGame(onComplete: onComplete)),
    ),
  );
}

void main() {
  testWidgets('publishes addition help context with operands', (tester) async {
    ...
    expect(context!.operation, 'addition');
